...
def main():
    ...
    tqdm.pandas()
    '''
    #Dane - prawdopodobnie potrzebna cała ścieżka 
    ...
    print('Wektoryzacja modelu\n')
    logistic_regression = train_model_logistic_regression(train_vec, y_train)
    print('Wektoryzacja modelu logistic_regression zakończona\n')
    decision_tree = train_model_decision_tree(train_vec, y_train)
    print('Ewaluacja modelu decision_tree zakończona\n')
    random_forest = train_model_random_forest(train_vec, y_train)
    print('Ewaluacja modelu random_forest zakończona\n')
    gradient_boosting = train_model_gradient_boosting(train_vec, y_train)
    print('Ewaluacja modelu gradient_boosting zakończona\n')
    svc = train_model_svc(train_vec, y_train)
